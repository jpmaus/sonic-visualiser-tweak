...
public:
    ...
    // JPMAUS  getter for user selection to iclude Tempo
    bool getTempoSelection() const {return  m_tempoSelection;}
    // End
    int exec() override;
...
protected:
    ...
    // JPMAUS  Check Box to opt for Tempo merge
    QCheckBox* _tempoChkBx;
    bool m_tempoSelection=false;
    // End
